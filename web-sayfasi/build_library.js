...
<body>
    ...
    <script>
        ...
        if (role === 'admin') {
        ...
        } else if (role === 'author' || role === 'denetim') {
            /* 'denetim' de bir yazardır — rafta kendi kitabını görür.
               Ayrıcalığı BAŞKALARININ yazılarını onaylamak ve bu onay
               panelde yapılıyor, kütüphanede değil. Onay panelinin düğmesi
               denetim için de gösteriliyor. */
            document.getElementById('yonetim-butonu').style.display =
                (role === 'denetim') ? 'inline-flex' : 'none';
            ...
            document.getElementById('hosgeldiniz-mesaj').innerHTML =
                (role === 'denetim' ? '🛡️ Hoş geldiniz Denetim, <strong>' : '✍️ Hoş geldiniz Yazar, <strong>')
                + yazarIsim + '</strong>';
